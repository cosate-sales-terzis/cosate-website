...
async function fetchProperties() {
    ...
    try {
        const response = await fetch('static/js/data/properties.json');
    ...
    return `
        <div class="property-card animate-on-scroll">
            <div class="property-card-image">
                <img src="${prop.main_image}" alt="${title}" onerror="this.onerror=null;this.src='static/assets/images/placeholder.jpg';">
...
export async function loadPartials() {
    const partials = [
        { id: 'header-placeholder', url: 'templates/partials/header.html' },
        { id: 'footer-placeholder', url: 'templates/partials/footer.html' }
    ];
